                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="name"
                                               ...
                                               value="<?php echo e($appointment->name); ?>" <?php echo e(in_array($appointment->status,[2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="phone"
                                               ...
                                               value="<?php echo e($appointment->phone); ?>" <?php echo e(in_array($appointment->status,[2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="date" name="date"
                                               id="date_start" value="<?php echo e($appointment->date); ?>" <?php echo e(in_array($appointment->status,[2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control form-control-sm"
                                            id="price" name="room_id" <?php echo e(in_array($appointment->status,[2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control form-control-sm"
                                            id="price" name="employee_id" <?php echo e(in_array($appointment->status,[2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($employee->id); ?>"
                                                    <?php echo e($employee->id == $employee->id ? 'selected':''); ?>><?php echo e($employee->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = config('system.appointment'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($k,[0,1,4])): ?>
                                                    <option value="<?php echo e($k); ?>"
                                                            <?php echo e($k == $appointment->status ? 'selected':''); ?>><?php echo e($v); ?></option>
                                                <?php endif; ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\luanvan\resources\views/admin/appointments/edit.blade.php ENDPATH**/ ?>