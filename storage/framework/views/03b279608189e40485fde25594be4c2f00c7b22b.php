                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" type="text" id="old_electric" name="old_electric"
                                                               value="<?php echo e($oldElectric); ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" type="text" id="old_water" name="old_water" value="<?php echo e($oldWater); ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" id="indebt"
                                               value="<?php echo e($inDebt); ?>" hidden readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\lv\resources\views/admin/bills/add.blade.php ENDPATH**/ ?>