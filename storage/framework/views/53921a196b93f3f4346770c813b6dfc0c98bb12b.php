                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="name"
                                               ...
                                               value="<?php echo e($service->name); ?>" <?php echo e((in_array($service->id,[1,2])||$service->bookings()->exists()) ? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit_price"
                                            class="custom-select custom-select-sm form-control form-control-sm" <?php echo e((in_array($service->id,[1,2])||$service->bookings()->exists()) ? "style=pointer-events:none" : ''); ?>>
                                        <?php $__currentLoopData = config('system.unit_price'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(in_array($service->id,[1,2])): ?>
                                                <option value="<?php echo e($k); ?>" <?php echo e($service->unit_price == $k ? 'selected':''); ?>><?php echo e($v); ?></option>
                                            <?php endif; ?>
                                            <?php if($k>1): ?>
                                            <option value="<?php echo e($k); ?>" <?php echo e($service->unit_price == $k ? 'selected':''); ?>><?php echo e($v); ?></option>
                                            <?php endif; ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\lv\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>