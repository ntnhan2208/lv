                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="name"
                                               ...
                                               value="<?php echo e($service->name); ?>" <?php echo e(in_array($service->id,[1,2]) ? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit_price"
                                            class="custom-select custom-select-sm form-control form-control-sm" <?php echo e(in_array($service->id,[1,2]) ? "style=pointer-events:none" : ''); ?>>
