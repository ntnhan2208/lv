                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="checkbox checkbox-success checkbox-circle">
                                            <input id="checkbox-<?php echo e($value->id); ?>" type="checkbox" <?php echo e($value->status == 1 ? 'checked disabled' : ''); ?>  onclick="if(!confirm('Xác nhận thay đổi trạng thái thanh toán'))
												  {return false;} else status(<?php echo e($value->id); ?>)">
                                            <label for="checkbox-<?php echo e($value->id); ?>">
                                                Đã thanh toán
                                            </label>
                                        </div>
                                    </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\lv\resources\views/admin/employees/index.blade.php ENDPATH**/ ?>