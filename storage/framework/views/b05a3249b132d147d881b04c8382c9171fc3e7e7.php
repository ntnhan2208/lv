                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="name"
                                               ...
                                               value="<?php echo e($appointment->name); ?>" <?php echo e((in_array($appointment->status,[1,2,3,4]) || \Illuminate\Support\Facades\Auth::user()->role==1 )? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="phone"
                                               ...
                                               value="<?php echo e($appointment->phone); ?>" <?php echo e((in_array($appointment->status,[1,2,3,4]) || \Illuminate\Support\Facades\Auth::user()->role==1)? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="date" name="date"
                                               id="date_start" value="<?php echo e($appointment->date); ?>" <?php echo e((in_array($appointment->status,[1,2,3,4]) || \Illuminate\Support\Facades\Auth::user()->role==1)? "style=pointer-events:none" : ''); ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control form-control-sm"
                                            id="price" name="room_id" <?php echo e((in_array($appointment->status,[1,2,3,4]) || \Illuminate\Support\Facades\Auth::user()->role==1)? "style=pointer-events:none" : ''); ?>>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control form-control-sm"
                                            id="price" name="employee_id" <?php echo e((in_array($appointment->status,[1,2,3,4]) || \Illuminate\Support\Facades\Auth::user()->role==1)? "style=pointer-events:none" : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-sm form-control form-control-sm"
                                            name="status" <?php echo e(in_array($appointment->status,[1,2,3,4]) ? "style=pointer-events:none" : ''); ?>>
                                        <?php if(in_array($appointment->status,[1,2,3,4])): ?>
