        ...
        <div class="col-lg-12">
            <div class="card mt-3">
                <div class="card-body shadow-lg bg-white rounded">
                    <form action="<?php echo e(route('store_for_new',$request_booking->id)); ?>" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="name" class="form-control"
                                               value="<?php echo e($request_booking->name); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="personal_id"
                                               class="form-control"
                                               value="<?php echo e($request_booking->personal_id); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="phone"
                                               class="form-control"
                                               value="<?php echo e($request_booking->phone); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="email" class="form-control"
                                               value="<?php echo e($request_booking->email); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="date" name="date_start"
                                                       id="date_start" value="<?php echo e($request_booking->date_start); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="date" name="date_end"
                                                       id="date_end" value="<?php echo e($request_booking->date_end); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <select class="custom-select custom-select-sm form-control form-control-sm"
                                                ...
                                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($room->id); ?>"
                                                            ...
                                                            <?php if($room->id==$request_booking->room_id): ?> selected <?php endif; ?>><?php echo e($room->name); ?></option>
                                        ...
                                        <div class="form-group" name="price-cal">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="total_room" type="text" id="result1"
                                                       value="<?php echo e($request_booking->total_room); ?>" readonly hidden>
                                            </div>
                                        </div>
                                            ...
                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="custom-control custom-checkbox" id="service">
                                                    <input type="checkbox" class="custom-control-input"
                                                           ...
                                                           <?php if($request_booking->services->contains($service->id)): ?> checked <?php endif; ?>>
                                        ...
                                        <div class="form-group" name="price-cal">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="total_service" type="text"
                                                       id="result3" value="<?php echo e($request_booking->total_service); ?>" readonly
                                                       hidden>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                 ...
                                 <textarea name="request"
                                           class="form-control"
                                           placeholder="<?php echo e(trans('site.booking.request')); ?>"><?php echo e($request_booking->request); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="total_price2" name="total_price"
                                           value="<?php echo e($request_booking->total_price); ?>" readonly hidden>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                        ...
                                        <select name="paid"
                                            ...
                                            <?php $__currentLoopData = config('system.paid'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($k); ?>"
                                                        <?php if($request_booking->paid == $k): ?> selected <?php endif; ?>><?php echo e($v); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\luanvan\resources\views/admin/request-bookings/add-for-new-customer.blade.php ENDPATH**/ ?>