        ...
        <div class="col-lg-12">
            <div class="card mt-3">
                <div class="card-body shadow-lg bg-white rounded">
                    <form action="<?php echo e(route('store_for_old',$request_booking->id)); ?>" method="POST"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="example-input1-group1" name="customer_id"
                                               class="form-control"
                                               value="<?php echo e($customer->id); ?>" readonly hidden>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
