                ...
                <div class="row">
                    <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 text-center">
                            <div class="text">
                                <strong class="number"><?php echo e($rooms); ?></strong>
                                <span>Phòng</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 text-center">
                            <div class="text">
                                <strong class="number"><?php echo e($services->count()); ?></strong>
                                <span>Dịch vụ</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18 text-center">
                            <div class="text">
                                <strong class="number"><?php echo e($employees); ?></strong>
                                <span>Nhân viên</span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH D:\DEV\luanvan\resources\views/web/about.blade.php ENDPATH**/ ?>