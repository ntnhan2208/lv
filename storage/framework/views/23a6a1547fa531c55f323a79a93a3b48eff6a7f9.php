                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="example-input1-group1" name="phone"
                                               ...
                                               value="<?php echo e($appointment->phone); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                            ...
                                            <select class="custom-select custom-select-sm form-control form-control-sm"
                                                ...
                                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($room->id); ?>"
                                                            data-price="<?php echo e($room->price); ?>" <?php echo e($appointment->room_id == $room->id ? 'selected':''); ?>><?php echo e($room->name); ?></option>
                                        ...
                                        <div class="form-group" name="price-cal">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="text" id="result2"
                                                       name="total_deposits2" value="<?php echo e(old('total_deposits2')); ?>"
                                                       readonly>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" id="total_price" name="total_price2"
                                           value="<?php echo e(old('total_price2')); ?>"
                                           readonly>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\lv\resources\views/admin/bookings/add-from-appointment.blade.php ENDPATH**/ ?>