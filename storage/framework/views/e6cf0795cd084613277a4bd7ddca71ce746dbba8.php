                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" name="confirm_password" class="form-control"
                                       placeholder="<?php echo e(trans('site.admin.confirm_password')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEV\luanvan\resources\views/admin/admins/change-password.blade.php ENDPATH**/ ?>